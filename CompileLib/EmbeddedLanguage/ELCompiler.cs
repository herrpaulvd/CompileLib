                            ...
                            else
                            {
                                f.AddOperation(
                                    binary.Operation switch
                                    {
                                        ...
                                        BinaryOperationType.GREATER => Assembler.GREATER,
                                        BinaryOperationType.LESSEQ => Assembler.LESSEQ,
                                        BinaryOperationType.GREATEREQ => Assembler.GREATEREQ,
                                        BinaryOperationType.AND => Assembler.AND,
                                        BinaryOperationType.OR => Assembler.OR,
                                        BinaryOperationType.XOR => Assembler.XOR,
                                        BinaryOperationType.SL => Assembler.SL,
                                        BinaryOperationType.SR => Assembler.SR,
                                        _ => throw new NotImplementedException()
                                    },
                                    expr2operand[e.ID],
                                    expr2operand[binary.Left.ID],
