...
{
    internal class Syntax_v2 // TODO: отлично, но нужен стресс TODO см. todolib.txt
    {
        ...
        public static Expression? ReadRoundCall(
            [RequireTags("expr-atom")] Expression callee,
            [Keywords("(")] string brOpen,
        ...
        public static Expression? ReadDotExpression(
            [RequireTags("expr-atom")] Expression left,
        ...
        [SetTag("expr")]
        public static Expression? ConvertAtom2Expr(
